...
const LoginPage = () => {
	const handleLogin = () => {
		window.open(`https://github-2-0.onrender.com/api/auth/github`, "_self")
	}
	return (
			...
			<div className='w-full bg-glass rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0'>
				<div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
					...
					<button
						...
						focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg flex gap-2 p-2 items-center w-full text-center justify-center'
						onClick={handleLogin}
					>
